      ...
      <a-row>
            ...
            <a-row :gutter="16">
              ...
              <a-col :span="8">
                ...
                >
                  <a-date-picker
                    style="width: 200px"
                    v-model:model-value="searchForm.startDate"
                  />
                </a-form-item>
              </a-col>
              ...
              <a-col :span="8">
                ...
                >
                  <a-date-picker
                    style="width: 200px"
                    v-model:model-value="searchForm.endDate"
                  />
                </a-form-item>
              </a-col>
              <a-col :span="8">
        ...
        <a-col :span="8" :flex="'86px'" style="text-align: right">
          <a-space direction="vertical" :size="18">
            ...
            <a-button status="success" @click="handleResetSearchForm"
      ...
      >
        <template #stu="{ record }">
          <span v-if="record.status == 0"
            ><a-tag color="red">未归还</a-tag></span
          >
          <span v-else-if="record.status == 1"
            ><a-tag color="green">已归还</a-tag></span
          >
        ...
        <template #opt="{ record }">
          <a-space>
            <a-button type="primary" size="mini" @click="handleClick(record)"
              >编辑</a-button
            >
            <a-popconfirm
...
const handleBeforeOk = () => {
  ...
  //编辑信息提交
  Api.put('/bookings/' + form.value.registration, form.value).then(() => {
    visible.value = false
    getAllBookings()
